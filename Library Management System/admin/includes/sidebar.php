...
#sidebar-container .list-group .list-group-item[aria-expanded="true"] .submenu-icon::after {
  ...
  padding-left: 10px;
    ...
    <div id="sidebar-container" class="sidebar-expanded h-100 d-none d-md-block"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
